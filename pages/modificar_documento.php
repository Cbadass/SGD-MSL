...
// Obtener datos de estudiante y profesional
...
$stmtProf = $conn->prepare("SELECT * FROM profesionales WHERE Id_prof_doc = ?");
  ...
  <div class="container-form">
    ...
    <div class="flex-fill">
      ...
      <div class="card-usuario">
        ...
        <!-- Aquí puedes incluir un buscador o un botón para "Cambiar Estudiante" -->
      </div>
      ...
      <div class="card-usuario">
        ...
        <!-- Aquí también puedes incluir un buscador o botón -->
      </div>
    </div>
  </div>
